...
AGENT_SELF_VALIDATION_AUTO_ON_WITH_WARNINGS = M(
    "AGENT_SELF_VALIDATION_AUTO_ON_WITH_WARNINGS"
)
...
AUTHORIZATION_SUCCESSFUL = M("AUTHORIZATION_SUCCESSFUL")
BAD_CLUSTER_STATE_FORMAT = M("BAD_CLUSTER_STATE_FORMAT")
BAD_CLUSTER_STATE_DATA = M("BAD_CLUSTER_STATE_DATA")
BAD_PCMK_API_RESPONSE_FORMAT = M("BAD_PCMK_API_RESPONSE_FORMAT")
...
BOOTH_TICKET_CHANGING_STATE = M("BOOTH_TICKET_CHANGING_STATE")
BOOTH_TICKET_CLEANUP = M("BOOTH_TICKET_CLEANUP")
...
BOOTH_TICKET_NOT_IN_CIB = M("BOOTH_TICKET_NOT_IN_CIB")
...
STOPPING_RESOURCES = M("STOPPING_RESOURCES")
STOPPED_RESOURCES_BEFORE_DELETE_CHECK_SKIPPED = M(
    "STOPPED_RESOURCES_BEFORE_DELETE_CHECK_SKIPPED"
)
...
CANNOT_MOVE_RESOURCE_CLONE_INNER = M("CANNOT_MOVE_RESOURCE_CLONE_INNER")
...
CANNOT_REMOVE_RESOURCES_NOT_STOPPED = M("CANNOT_REMOVE_RESOURCES_NOT_STOPPED")
...
CIB_CLUSTER_NAME_REMOVAL_FAILED = M("CIB_CLUSTER_NAME_REMOVAL_FAILED")
CIB_CLUSTER_NAME_REMOVAL_STARTED = M("CIB_CLUSTER_NAME_REMOVAL_STARTED")
CIB_CLUSTER_NAME_REMOVED = M("CIB_CLUSTER_NAME_REMOVED")
...
CIB_REMOVE_REFERENCES = M("CIB_REMOVE_REFERENCES")
CIB_REMOVE_RESOURCES = M("CIB_REMOVE_RESOURCES")
CIB_REMOVE_DEPENDANT_ELEMENTS = M("CIB_REMOVE_DEPENDANT_ELEMENTS")
...
CIB_XML_MISSING = M("CIB_XML_MISSING")
...
CLUSTER_NAME_ALREADY_IN_USE = M("CLUSTER_NAME_ALREADY_IN_USE")
CLUSTER_NOT_IMPORTED_FOR_MANAGEMENT = M("CLUSTER_NOT_IMPORTED_FOR_MANAGEMENT")
IMPORTED_CLUSTER_HAS_NO_NODES = M("IMPORTED_CLUSTER_HAS_NO_NODES")
PCS_SETTINGS_CONF_DOES_NOT_EXIST = M("PCS_SETTINGS_CONF_DOES_NOT_EXIST")
CLUSTER_OPTIONS_METADATA_NOT_SUPPORTED = M(
    "CLUSTER_OPTIONS_METADATA_NOT_SUPPORTED"
)
...
COMMAND_ARGUMENT_TYPE_MISMATCH = M("COMMAND_ARGUMENT_TYPE_MISMATCH")
...
COROSYNC_CONFIG_INVALID_PREVENTS_CLUSTER_JOIN = M(
    "COROSYNC_CONFIG_INVALID_PREVENTS_CLUSTER_JOIN"
)
...
DLM_CLUSTER_RENAME_NEEDED = M("DLM_CLUSTER_RENAME_NEEDED")
...
EMPTY_RESOURCE_SET = M("EMPTY_RESOURCE_SET")
...
GFS2_LOCK_TABLE_RENAME_NEEDED = M("GFS2_LOCK_TABLE_RENAME_NEEDED")
GUEST_NODE_NAME_ALREADY_EXISTS = M("GUEST_NODE_NAME_ALREADY_EXISTS")
...
ID_DOES_NOT_SUPPORT_ELEMENT_DESCRIPTIONS = M(
    "ID_DOES_NOT_SUPPORT_ELEMENT_DESCRIPTIONS"
)
ID_NOT_FOUND = M("ID_NOT_FOUND")
INCORRECT_CREDENTIALS = M("INCORRECT_CREDENTIALS")
...
INVALID_ID_TYPE = M("INVALID_ID_TYPE")
...
META_ATTRS_NOT_VALIDATED_LOADING_ERROR = M(
    "META_ATTRS_NOT_VALIDATED_LOADING_ERROR"
)
META_ATTRS_NOT_VALIDATED_UNSUPPORTED_TYPE = M(
    "META_ATTRS_NOT_VALIDATED_UNSUPPORTED_TYPE"
)
META_ATTRS_UNKNOWN_TO_PCMK = M("META_ATTRS_UNKNOWN_TO_PCMK")
...
NO_HOST_SPECIFIED = M("NO_HOST_SPECIFIED")
NO_STONITH_MEANS_WOULD_BE_LEFT = M("NO_STONITH_MEANS_WOULD_BE_LEFT")
NO_STONITH_MEANS_WOULD_BE_LEFT_DUE_TO_PROPERTIES = M(
    "NO_STONITH_MEANS_WOULD_BE_LEFT_DUE_TO_PROPERTIES"
)
...
NODE_NOT_IN_CLUSTER = M("NODE_NOT_IN_CLUSTER")
NODE_REMOVE_IN_PACEMAKER_FAILED = M("NODE_REMOVE_IN_PACEMAKER_FAILED")
NODE_REMOVE_IN_PACEMAKER_SKIPPED = M("NODE_REMOVE_IN_PACEMAKER_SKIPPED")
NODE_REPORTS_UNEXPECTED_CLUSTER_NAME = M("NODE_REPORTS_UNEXPECTED_CLUSTER_NAME")
...
PACEMAKER_RUNNING = M("PACEMAKER_RUNNING")
...
PARSE_ERROR_INVALID_FILE_STRUCTURE = M("PARSE_ERROR_INVALID_FILE_STRUCTURE")
PARSE_ERROR_JSON_FILE = M("PARSE_ERROR_JSON_FILE")
PCS_CFGSYNC_CONFIG_ACCEPTED = M("PCS_CFGSYNC_CONFIG_ACCEPTED")
PCS_CFGSYNC_CONFIG_SAVE_ERROR = M("PCS_CFGSYNC_CONFIG_SAVE_ERROR")
PCS_CFGSYNC_CONFIG_REJECTED = M("PCS_CFGSYNC_CONFIG_REJECTED")
PCS_CFGSYNC_CONFIG_UNSUPPORTED = M("PCS_CFGSYNC_CONFIG_UNSUPPORTED")
PCS_CFGSYNC_CONFLICT_REPEAT_ACTION = M("PCS_CFGSYNC_CONFLICT_REPEAT_ACTION")
PCS_CFGSYNC_FETCHING_NEWEST_CONFIG = M("PCS_CFGSYNC_FETCHING_NEWEST_CONFIG")
PCS_CFGSYNC_SENDING_CONFIGS_TO_NODES = M("PCS_CFGSYNC_SENDING_CONFIGS_TO_NODES")
PCS_CFGSYNC_SENDING_CONFIGS_TO_NODES_FAILED = M(
    "PCS_CFGSYNC_SENDING_CONFIGS_TO_NODES_FAILED"
)
...
RESOURCE_RESTART_ERROR = M("RESOURCE_RESTART_ERROR")
RESOURCE_RESTART_NODE_IS_FOR_MULTIINSTANCE_ONLY = M(
    "RESOURCE_RESTART_NODE_IS_FOR_MULTIINSTANCE_ONLY"
)
RESOURCE_RESTART_USING_PARENT_RESOURCE = M(
    "RESOURCE_RESTART_USING_PARENT_RESOURCE"
)
...
RESOURCE_WAIT_DEPRECATED = M("RESOURCE_WAIT_DEPRECATED")
...
UNABLE_TO_GET_CLUSTER_INFO_FROM_STATUS = M(
    "UNABLE_TO_GET_CLUSTER_INFO_FROM_STATUS"
)
...
USE_COMMAND_NODE_REMOVE_REMOTE = M("USE_COMMAND_NODE_REMOVE_REMOTE")
USE_COMMAND_NODE_REMOVE_GUEST = M("USE_COMMAND_NODE_REMOVE_GUEST")
USE_COMMAND_REMOVE_AND_ADD_GUEST_NODE = M(
    "USE_COMMAND_REMOVE_AND_ADD_GUEST_NODE"
)
